...
run(
  ...
  [
    ...
    "apps/cli-go/internal/utils/docker_acl_darwin_test.go",
    "apps/cli-go/internal/utils/docker_isolation_test.go",
    "apps/cli-go/internal/utils/docker_special_unix_test.go",
    "apps/cli-go/internal/utils/isolation/hostconfig.go",
    "apps/cli-go/internal/utils/isolation/hostconfig_test.go",
    "apps/cli-go/internal/utils/isolation/hostsource_acl_darwin.go",
    "apps/cli-go/internal/utils/isolation/hostsource_acl_darwin_test.go",
    "apps/cli-go/internal/utils/isolation/hostsource_acl_linux.go",
    "apps/cli-go/internal/utils/isolation/hostsource_trust_unix.go",
    "apps/cli-go/internal/utils/isolation/hostsource_trust_unix_test.go",
    "apps/cli-go/internal/utils/isolation/hostsource_trust_unsupported.go",
