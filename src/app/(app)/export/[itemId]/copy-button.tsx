...
export function CopyButton({ text, label }: { text: string; label: string }) {
  ...
  return (
    <button
      ...
      className={
        copied
          ? "rounded-md border border-success-border bg-success-soft px-3.5 py-2 text-[13.5px] font-medium text-success-soft-fg"
          : "rounded-md border border-border-strong bg-surface px-3.5 py-2 text-[13.5px] font-medium text-fg shadow-xs transition-colors hover:bg-surface-2"
      }
      aria-label={label}
    >
