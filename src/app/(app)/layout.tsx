...
const PREVIEW_SEARCH_FIXTURES: PaletteHit[] = [
  { itemId: "fx-1", title: "Acer Predator Helios 300", status: "draft", thumbUrl: "/demo/authentic/acer-predator-a1-open.jpg", createdAt: "2026-06-11T15:00:00Z" },
...
const PREVIEW_NOTIFICATIONS: NotificationView[] = [
  { id: "n-1", kind: "buyer_message", title: "New question on Acer Predator Helios 300", body: "“Does the original charger come with it?” — a reply is drafted for you.", href: "/inbox", read: false, createdAt: "2026-06-16T14:10:00Z" },
