 ...
 * green, Ready/Processing blue, Needs attention red, Draft/Archived a calm
...
export function StatusBadge({
  ...
  pulse?: boolean;
  /** Replaces the leading dot with a clock glyph when a future time-based state
   * needs it. Honors `dot`: a `dot={false}` badge shows neither. */
  icon?: "clock";
}) {
  return (
    <span
