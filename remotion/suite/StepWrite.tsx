  ...
  return (
    <div
      style={{
        ...
        height: rect.h,
        borderRadius: 11,
        border: `1px solid ${active ? "rgba(0,128,96,0.45)" : LINE}`,
    ...
    <PaneFrame swapAt={14}>
      ...
      <div
        style={{
          ...
          height: 42,
          borderRadius: 10,
          border: `1px solid ${titleTyping ? "rgba(0,128,96,0.45)" : LINE}`,
          boxShadow: titleTyping ? "0 0 0 3px rgba(0,128,96,0.1)" : undefined,
          background: SLAB,
          display: "flex",
          alignItems: "center",
          padding: "0 13px",
      ...
      <div
        style={{
          ...
          height: 124,
          borderRadius: 10,
          border: `1px solid ${descTyping ? "rgba(0,128,96,0.45)" : LINE}`,
          boxShadow: descTyping ? "0 0 0 3px rgba(0,128,96,0.1)" : undefined,
          background: SLAB,
          padding: "11px 13px",
          fontSize: 13.5,
          lineHeight: 1.6,
